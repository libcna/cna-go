...
| --- | ---: | --- | --- |
| Root types | 4 | `ACTIONABLE_LOCAL` | nothing external |
...
GraphicsDeviceInformation and PreparingDeviceSettingsEventArgs are the last two blockers of GraphicsDeviceManager's six missing members; TitleContainer and FrameworkDispatcher are small statics that fold into whichever milestone first needs them
